        ...
        @auth
            ...
            <x-nav-links href="#" text="Views">
                <ul>
                    ...
                    <x-nav-link href="{{ route('entry.list-recurrences') }}" :active="Route::is('entry.list-recurrences')">List recurrences (edit)</x-nav-link>
                    ...
                    <x-nav-link href="{{ route('graphs-new.expenses') }}" :active="Route::is('graphs-new.expenses')">Expenses</x-nav-link>
                </ul>   
            </x-nav-links>
